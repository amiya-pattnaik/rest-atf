...
module.exports = {
  ...
  **/
  ...
  /***************************************************************************************/
  /*
   * method getCookie(options, callback)
   * @param {options} - options object, which contains , `url`, `method`, `headers`, etc. in the form of key-value
   * @param {callback} callback method that contains command results
   * and gets called when the command finishes
   * this method getCookies will retun first cookie based on the 'set-cookie' attribute from response headers.
   **/
  /****************************************************************************************/
  getCookies : function (options, callback){
  ...
  /***************************************************************************************/
  /*
   * method countKeyValue(obj)
   * @param {options} - json options object, from which how many key-values to be counted
   * this method returns the count key-values of the json options
   **/
  /****************************************************************************************/
  countKeyValuePair : function (obj) {
